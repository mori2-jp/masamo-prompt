...
No 36, 37, 40, 41, 52, 58 では割り算についての学習を予定していますが、ここの2桁の割り算を追加したい。
必要水準と補足・背景がブランクを考えて行を追加できますか？
...
6 3桁÷1桁の計算(あまりあり）※あまりをキーパッドに追加する
639÷3=▢
280÷40=(0を消せれば2桁÷1桁。0を消して計算を簡単にすることを理解させる狙い)
