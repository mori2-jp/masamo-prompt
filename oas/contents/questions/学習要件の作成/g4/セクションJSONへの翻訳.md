...
153	小4	B 図形	図形の概念について理解し，その性質について考察すること	面積の基礎	sec_s1_g4_1100	長さを手がかりに広さをおよそ見積もる	u100	縦と横のおおよその長さを使って，どのくらいのマス数になるか簡単に見当をつけられる	実測や正確な計算だけでなく，「だいたいこれくらい」という見積もりを通じて，身近な場面で活かせる面積感覚をはぐくむ
154	小4	B 図形	図形の概念について理解し，その性質について考察すること	面積の基礎	sec_s1_g4_1100	広さのくらべ方と表し方	u300	・単位正方形で分割し複雑な図形の面積を合計して求められる。	・面積公式導入前に単位面積の概念を強化する。
155	小4	B 図形	図形の概念について理解し，その性質について考察すること	面積の基礎	sec_s1_g4_1100	大きな面積の単位	u400	・a (アール) や ha (ヘクタール) を理解しm² や km² との換算ができる。	・土地や森林面積のニュースを読み取る素地を付ける。
156	小4	B 図形	図形の概念について理解し，その性質について考察すること	面積の基礎	sec_s1_g4_1100	辺の長さと面積の関係	u500	・長方形・正方形で辺を n 倍すると面積が n² 倍になることを操作で確かめられる。	・平方数や比例の理解へ自然に接続する。
176	小4	B 図形	図形の概念について理解し，その性質について考察すること	四角形の形（平行四辺形，ひし形，台形）	sec_s1_g4_800	平行四辺形，ひし形，台形	u300	・辺や対角線の特徴を把握し，それぞれの図形を区別できる。	・直線の平行や垂直，頂点の位置関係に着目して図形を認識する。
177	小4	B 図形	図形の性質を日常生活に生かすこと	"四角形の形（平行四辺形，ひし形，台形）	"	sec_s1_g4_800	対角線と四角形の特ちょう	u600	・対角線の長さや交点の性質から四角形の種類を分類し説明できる。	・対角線を利用した作図や証明への導入とする。
178	小4	B 図形	図形の概念について理解し，その性質について考察すること	"四角柱・立方体（直方体，立方体）	"	sec_s1_g4_1200	立方体，直方体	u100	・面や辺，頂点の数などから，立方体と直方体の構造の違いをとらえられる。	・いろいろな箱（教室の家具など）を観察し，直方体や立方体に当てはまるかを確かめる。
179	小4	B 図形	図形の構成の仕方について考察すること	"四角形（平行四辺形，ひし形，台形）の構成	"	sec_s1_g4_800	平行四辺形，ひし形，台形	u400	・それぞれの四角形を紙から切り出したり，組み合わせたりして作る活動ができる。	・辺の長さや角度に着目して作図し，特徴を視覚的に確認する。
180	小4	B 図形	図形の構成の仕方について考察すること	"直方体の見取り図・展開図	"	sec_s1_g4_1200	直方体の見取り図，展開図	u200	・直方体を開いたときの展開図を描いたり，見取り図で空間的構造を把握したりできる。	・底面や側面を意識しながら工作用紙などで組み立てる操作を重視。
181	小4	B 図形	図形の計量の仕方について考察すること	"角の大きさ・計測	"	sec_s1_g4_400	角の大きさ	u100	"・分度器を用いて角度を測定できる。
"	・作図と測定の両面から角度の概念を深める。
182	小4	B 図形	図形の計量の仕方について考察すること	"角の大きさ・計測	"	sec_s1_g4_400	角の大きさ	u200	・90°，180°などの基準角を正しく捉える。	・作図と測定の両面から角度の概念を深める。
183	小4	B 図形	図形の計量の仕方について考察すること	"正方形，長方形の求積	"	sec_s1_g4_1100	正方形，長方形の求積	u200	・辺の長さを用いて正方形や長方形の面積を求められる。	・たて×よこ の公式を体感的に納得し，長さと面積の関係を関連付ける。
184	小4	B 図形	図形の性質を日常生活に生かすこと	"四角形の形（平行四辺形，ひし形，台形）	"	sec_s1_g4_800	平行四辺形，ひし形，台形	u500	・看板や看取り図など，四角形の性質を応用している事例に気づける。	・台形の橋脚やひし形の標識など，現実のものづくりとの関連を示す。
185	小4	B 図形	図形の性質を日常生活に生かすこと	"四角柱・立方体（直方体，立方体）	"	sec_s1_g4_1200	立方体，直方体	u300	・教室や段ボール箱などを立方体・直方体として理解し，寸法の測り方を工夫できる。	・物の収納や配置で箱形の性質を活かすなど，実践的場面を設定する。
186	小4	B 図形	図形の性質を日常生活に生かすこと	"ものの位置の表し方	"	sec_s1_g4_1200	ものの位置の表し方	u400	・平面図や地図を使って，縦横の座標や方位などを用い場所を説明できる。	・学校の見取り図などで，「(横, 縦)」のような表し方に慣れさせる。
187	小4	B 図形	図形の性質を日常生活に生かすこと	直線の交わり方や並び方	sec_s1_g4_800	直線の交わり方	u100	・二つの直線が交わるときに直角かどうかを判断し，角度の基礎概念を押さえられる。	・多様な図形例で交わり方を観察し，垂直の概念や交差の仕組みを再確認させる。
188	小4	B 図形	図形の性質を日常生活に生かすこと	直線の交わり方や並び方	sec_s1_g4_800	直線の並び方	u200	・二つの直線が平行かどうかを図や作図で見極め，幅が一定で交わらない性質を説明できる。	・線路やノートの罫線など身近な平行の事例を示し，平行線の見方や特徴を捉えさせる。
236	小4	C 変化と関係	伴って変わる二つの数量の変化や対応の特徴を考察すること	"表や式，折れ線グラフ	"	sec_s1_g4_200	表や式，折れ線グラフ	u100	・2つの数量の変化を表や折れ線グラフで示し，増減の仕方をつかめる。	・身近な例（温度の推移，身長の伸びなど）でグラフ化する活動が効果的。
237	小4	C 変化と関係	ある二つの数量の関係と別の二つの数量の関係を比べること	簡単な割合・概数	sec_s1_g4_600	簡単な割合	u300	・「全体のうちの何割か」をイメージし，式や言葉で説明できる。	・お菓子の袋に占める割合等，分数・小数との関連付けを図る。
238	小4	C 変化と関係	二つの数量の関係の考察を日常生活に生かすこと	"表や式，折れ線グラフ	"	sec_s1_g4_200	表や式，折れ線グラフ	u200	・家庭の電気使用量やクラスの身長データなどをグラフにして読み取り，改善点を考える。	・生活面の課題を見つけ，数量関係の視点から解決策を導く意欲を高める。
239	小4	C 変化と関係	二つの数量の関係の考察を日常生活に生かすこと	簡単な割合・概数	sec_s1_g4_600	簡単な割合	u400	・割合を使って「全体に対してどれくらいの部分か」を把握し，日常の問題(料理の割合など)に活かす。	・比やパーセントの前段階として，分数や小数との結び付きを大事にする。
271	小4	D データの活用	目的に応じてデータを収集，分類整理し，結果を適切に表現すること	"記録を整理して表やグラフに表そう（総合）	"	sec_s1_g4_1300	目的に応じたデータの収集と分類整理	u100	・学習課題に沿って何を集めるかを決め，表やメモに整理できる。	・課題解決型学習を意識し，自主的にデータを集める力を育成する。
272	小4	D データの活用	目的に応じてデータを収集，分類整理し，結果を適切に表現すること	"記録を整理して表やグラフに表そう（総合）	"	sec_s1_g4_1300	適切なグラフの選択	u200	・棒グラフ，折れ線グラフ，円グラフ等の特徴を知り，表現したい内容に合わせて選べる。	・「経時変化なら折れ線」「割合なら円」など，グラフ選択の基準を身に付ける。
273	小4	D データの活用	目的に応じてデータを収集，分類整理し，結果を適切に表現すること	"記録を整理して表やグラフに表そう（総合）	"	sec_s1_g4_1300	二次元の表	u300	・2つの観点を掛け合わせた表を作成し，多面的に比較や集計を行える。	・ある程度大きめのデータでも整理できるように行列形式の見方を鍛える。
274	小4	D データの活用	目的に応じてデータを収集，分類整理し，結果を適切に表現すること	"記録を整理して表やグラフに表そう（総合）	"	sec_s1_g4_1300	折れ線グラフ	u400	・横軸を時間や連続量にして，折れ線で変化を可視化できる。	・気温変化や1日の行動記録など経時的データに適用し，その良さを体感。
275	小4	D データの活用	統計データの特徴を読み取り判断すること	"記録を整理して表やグラフに表そう（総合）	"	sec_s1_g4_1300	結論についての考察	u500	・作成したグラフや表から読み取れる特徴をもとに，自分なりの結論や意見をまとめられる。	・データの傾向を踏まえた提案（「ここを改善すれば…」など）へ展開させる。
276	小4	D データの活用	統計データの特徴を読み取り判断すること	"記録を整理して表やグラフに表そう（総合）	"	sec_s1_g4_1300	二次元の表，折れ線グラフ	u600	・複数観点を掛け合わせた表や，折れ線グラフを読み取り，変化の特徴を説明できる。	・単純な「多い/少ない」だけでなく，増減パターンや分布の偏りにも言及させる。
   ...
   "sections": [
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec100_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "億、兆の単位などの比べ方や表し方（統合的）"
               },
               "required_competency": {
                  "ja": "・1億や1兆などを正しく読み書きし，桁数を把握できる。"
               },
               "background": {
                  "ja": "・ニュースなどでよく見る大きな数を実感としてつかむ。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec100_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "10倍にした数、1/10 にした数"
               },
               "required_competency": {
                  "ja": "・10倍や1/10倍の変化を位取りで正しく理解し，数の増減を説明できる。"
               },
               "background": {
                  "ja": "・桁の移動を再確認し，小数を含む整数のスケール感や計算の仕組みを深める。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec100_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "掛け算"
            ...
            },
            {
               ...
               "required_competency": {
                  "ja": "・1億や1兆をニュースや社会の数値と関連づけてイメージできる。"
               },
               "background": {
                  "ja": "・親しみやすい例（全国人口や生産量など）を取り上げ，桁感覚を鍛える。"
               }
            }
         ]
      },
         ...
         "units": [
            {
               ...
               "required_competency": {
                  "ja": "・2つの数量の変化を表や折れ線グラフで示し，増減の仕方をつかめる。"
               },
               "background": {
                  "ja": "・身近な例（温度の推移，身長の伸びなど）でグラフ化する活動が効果的。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec200_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "表や式，折れ線グラフ"
               ...
               "required_competency": {
                  "ja": "・家庭の電気使用量やクラスの身長データなどをグラフにして読み取り，改善点を考える。"
               },
               "background": {
                  "ja": "・生活面の課題を見つけ，数量関係の視点から解決策を導く意欲を高める。"
               }
            }
         ]
      },
         ...
         "units": [
            {
               ...
               "required_competency": {
                  "ja": "・10や100などのまとまりでのわり算を素早く処理し、位取りを正しく把握できる。"
               },
               "background": {
                  "ja": "・乗法との逆演算関係を再確認し、大きな数の暗算力や手計算力を向上させる。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec300_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "1位数などによる除法（筆算）"
               ...
               "required_competency": {
                  "ja": "・2桁÷1桁や3桁÷1桁などのわり算を筆算で処理できる。"
               },
               "background": {
                  "ja": "・桁の扱いが複雑化するため，しっかりと手順を教える。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec300_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "2位数などによる除法（筆算）"
            ...
            },
            {
               ...
               "required_competency": {
                  "ja": "・1桁や10・100などの単位数の割り算を暗算で正確に行い、結果をすぐに導ける。"
               },
               "background": {
                  "ja": "・日常生活における簡便な計算に役立つよう暗算力を継続的に鍛え、効率化を図る。"
               }
            }
         ]
      },
         ...
         "units": [
            {
               ...
               "background": {
                  "ja": "・作図と測定の両面から角度の概念を深める。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec400_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "角の大きさ"
         ...
         "units": [
            {
               ...
               "required_competency": {
                  "ja": "・0.03と0.3のどちらが大きいかを位取りの考え方で正しく説明できる。"
               },
               "background": {
                  "ja": "・整数から小数へ，位を横へ広げる段階の学習。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec500_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "小数を用いた n 倍の意味"
               ...
               "required_competency": {
                  "ja": "・1.2倍や2.5倍など，小数倍を具体的な例と式で示せる。"
               },
               "background": {
                  "ja": "・拡大・縮小や単位量あたりの考え方とも関連づける。"
               }
            },
            {
               "order": 300,
               ...
               "required_competency": {
                  "ja": "・0.23+0.7など，小数第2～第3位程度の加減算を正確に行える。"
               },
               "background": {
                  "ja": "・小数点の位置合わせに慣れさせ，整数部分と小数部分を区別する。"
               }
            },
            {
               "order": 400,
               "unit_id": "unit_s1_g4_sec500_400",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "小数の乗法及び除法（小数×小数、小数÷小数）"
               },
               "required_competency": {
                  "ja": "・0.5×0.2や1.2÷0.4など，小数点の位置を正しく処理できる。"
               },
               "background": {
                  "ja": "・「小数点の移動量」を把握し，反復練習で確実性を高める。"
               }
            },
            {
               "order": 500,
               "unit_id": "unit_s1_g4_sec500_500",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "小数や分数の計算の活用"
               ...
               "required_competency": {
                  "ja": "・料理の分量や距離計算などで，小数・分数混在の計算を行い結果を解釈できる。"
               },
               "background": {
                  "ja": "・実際の測定やアクティビティを通じ，計算結果を検証する体験を大切に。"
               }
            }
         ]
      },
         ...
         "units": [
            {
               ...
               "required_competency": {
                  "ja": "・四捨五入や概数を用いておおよその値を出すなど，計算の手間を調整できる。"
               },
               "background": {
                  "ja": "・場面に応じて厳密な数値と概算を使い分ける力を育成する。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec600_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "目的に合った数の処理の仕方の活用"
               ...
               "required_competency": {
                  "ja": "・概算を使って大量のものの個数や総額をすばやく求められる。"
               },
               "background": {
                  "ja": "・精密さと効率のバランスを調整する判断力を養う。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec600_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "簡単な割合"
               ...
               "required_competency": {
                  "ja": "・「全体のうちの何割か」をイメージし，式や言葉で説明できる。"
               },
               "background": {
                  "ja": "・お菓子の袋に占める割合等，分数・小数との関連付けを図る。"
               }
            },
            {
               "order": 400,
               "unit_id": "unit_s1_g4_sec600_400",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "簡単な割合"
               ...
               "required_competency": {
                  "ja": "・割合を使って「全体に対してどれくらいの部分か」を把握し，日常の問題(料理の割合など)に活かす。"
               },
               "background": {
                  "ja": "・比やパーセントの前段階として，分数や小数との結び付きを大事にする。"
               }
            }
         ]
      },
         ...
         "units": [
            {
               ...
               "required_competency": {
                  "ja": "・四則計算の簡略化にこれらの法則を活用し，実際に手順を省力化できる。"
               },
               "background": {
                  "ja": "・式の一部をまとめたり展開したりする力を育て，中学の代数に備える。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec700_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "除法に関して成り立つ性質"
               ...
               "required_competency": {
                  "ja": "・(a ÷ b) ÷ c = a ÷ (b × c)などを小数や簡単な整数で確かめられる。"
               },
               "background": {
                  "ja": "・分数との関連理解（a/b ÷ c = a/b × 1/c）への布石となる。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec700_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "四則演算の結果の見積り"
               ...
               "required_competency": {
                  "ja": "・加減乗除が混ざった式で，ざっくりした答えを先に想定できる。"
               },
               "background": {
                  "ja": "・買い物や予算計算など，誤差と妥当性をチェックする習慣化。"
               }
            },
            {
               "order": 400,
               "unit_id": "unit_s1_g4_sec700_400",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "計算の工夫や確かめ"
               ...
               "required_competency": {
                  "ja": "・同じ計算を繰り返さなくても，分配法則や検算を使って効率よく確認できる。"
               },
               "background": {
                  "ja": "・自己点検を行う習慣づくりと，複数手段の併用を身に付ける。"
               }
            },
            {
               "order": 500,
               "unit_id": "unit_s1_g4_sec700_500",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "四則混合の式や ( ) を用いた式表現・式読み"
               },
               "required_competency": {
                  "ja": "・(3+2)×4-6などの演算順序を間違えずに処理し，式として適切に表せる。"
               },
               "background": {
                  "ja": "・中学の文字式へ向かう前に，( ) の優先順位などのルールを定着させる。"
               }
            },
            {
               "order": 600,
               "unit_id": "unit_s1_g4_sec700_600",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "公式についての考え"
               ...
               "required_competency": {
                  "ja": "・長方形の面積などを「たて×よこ」と一般化し，なぜそうなるかを理解する。"
               },
               "background": {
                  "ja": "・図を使った操作で公式を導き納得させるプロセスを重視。"
               }
            },
            {
               "order": 700,
               "unit_id": "unit_s1_g4_sec700_700",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "n、△などを用いた式表現（簡潔・一般的）"
               },
               "required_competency": {
                  "ja": "・(n+2)×3 のような抽象的表記を読んだり書いたりできる。"
               },
               "background": {
                  "ja": "・中学以降の文字式にスムーズに接続できるよう抽象化を体験させる。"
               }
            }
         ]
      },
         ...
         "units": [
            {
               ...
               "required_competency": {
                  "ja": "・二つの直線が交わるときに直角かどうかを判断し，角度の基礎概念を押さえられる。"
               },
               "background": {
                  "ja": "・多様な図形例で交わり方を観察し，垂直の概念や交差の仕組みを再確認させる。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec800_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "直線の並び方"
               ...
               "required_competency": {
                  "ja": "・二つの直線が平行かどうかを図や作図で見極め，幅が一定で交わらない性質を説明できる。"
               },
               "background": {
                  "ja": "・線路やノートの罫線など身近な平行の事例を示し，平行線の見方や特徴を捉えさせる。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec800_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "平行四辺形，ひし形，台形"
               ...
               "required_competency": {
                  "ja": "・辺や対角線の特徴を把握し，それぞれの図形を区別できる。"
               },
               "background": {
                  "ja": "・直線の平行や垂直，頂点の位置関係に着目して図形を認識する。"
               }
            },
            {
               "order": 400,
               "unit_id": "unit_s1_g4_sec800_400",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "平行四辺形，ひし形，台形"
               ...
               "required_competency": {
                  "ja": "・それぞれの四角形を紙から切り出したり，組み合わせたりして作る活動ができる。"
               },
               "background": {
                  "ja": "・辺の長さや角度に着目して作図し，特徴を視覚的に確認する。"
               }
            },
            {
               "order": 500,
               "unit_id": "unit_s1_g4_sec800_500",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "平行四辺形，ひし形，台形"
               ...
               "required_competency": {
                  "ja": "・看板や看取り図など，四角形の性質を応用している事例に気づける。"
               },
               "background": {
                  "ja": "・台形の橋脚やひし形の標識など，現実のものづくりとの関連を示す。"
               }
            }
         ]
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec900_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "分数（真分数、仮分数、帯分数）とその大きさの相違"
               },
               "required_competency": {
                  "ja": "・3/2=1 1/2(帯分数)など，分数表示の変換と大小関係を正しく理解する。"
               },
               "background": {
                  "ja": "・分数を統合的に捉えられるよう，図や具体物と結びつけて学ぶ。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec900_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "同分母分数の加法及び減法"
               ...
               "required_competency": {
                  "ja": "・分母が同じなら分子を足し引きすればよいことを理解し，計算できる。"
               },
               "background": {
                  "ja": "・帯分数への変換などを図で示し，概念を定着させる。"
               }
            },
            {
               "order": 600,
               "unit_id": "unit_s1_g4_sec900_600",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "小数や分数の計算の活用"
      ...
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec1000_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "数や図形の変化を整理し、複数の法則を組み合わせたパターンにも対応する。"
               },
               "required_competency": {
                  "ja": "・複合的な規則を含む問題を試行錯誤し、仮説を立てて検証できる。"
               },
               "background": {
                  "ja": "・多段階のパターン認識を通じて、中学数学の方程式や関数の理解を後押しする。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec1000_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "大小関係や加減乗除の規則を応用して、未知の項や幅を推測できる。"
               },
               "required_competency": {
                  "ja": "・図や表を活用して、途中の段階や次の段階にある要素を論理的に導ける。"
               },
               "background": {
                  "ja": "・規則の多様な捉え方を経験し、問題解決において見通しを立てる力を養う。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec1000_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "簡易な数列や図形のパターンを捉え、次の項や規則性を説明できる。"
               },
               "required_competency": {
                  "ja": "・一定の差やくり返しがある数列や図形を見抜き、言葉や式で表現できる。"
               },
               "background": {
                  "ja": "・学習指導要領にある関数的思考の素地を培い、高学年以降の発展に備える。"
               }
            }
         ]
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec1100_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "長さを手がかりに広さをおよそ見積もる"
               },
               "required_competency": {
                  "ja": "縦と横のおおよその長さを使って，どのくらいのマス数になるか簡単に見当をつけられる"
               },
               "background": {
                  "ja": "実測や正確な計算だけでなく，「だいたいこれくらい」という見積もりを通じて，身近な場面で活かせる面積感覚をはぐくむ"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec1100_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "正方形，長方形の求積"
               ...
               "required_competency": {
                  "ja": "・辺の長さを用いて正方形や長方形の面積を求められる。"
               },
               "background": {
                  "ja": "・たて×よこ の公式を体感的に納得し，長さと面積の関係を関連付ける。"
               }
            }
         ]
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec1200_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "立方体，直方体"
               ...
               "required_competency": {
                  "ja": "・面や辺，頂点の数などから，立方体と直方体の構造の違いをとらえられる。"
               },
               "background": {
                  "ja": "・いろいろな箱（教室の家具など）を観察し，直方体や立方体に当てはまるかを確かめる。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec1200_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "直方体の見取り図，展開図"
               ...
               "required_competency": {
                  "ja": "・直方体を開いたときの展開図を描いたり，見取り図で空間的構造を把握したりできる。"
               },
               "background": {
                  "ja": "・底面や側面を意識しながら工作用紙などで組み立てる操作を重視。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec1200_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "立方体，直方体"
               ...
               "required_competency": {
                  "ja": "・教室や段ボール箱などを立方体・直方体として理解し，寸法の測り方を工夫できる。"
               },
               "background": {
                  "ja": "・物の収納や配置で箱形の性質を活かすなど，実践的場面を設定する。"
               }
            },
            {
               "order": 400,
               "unit_id": "unit_s1_g4_sec1200_400",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "ものの位置の表し方"
               ...
               "required_competency": {
                  "ja": "・平面図や地図を使って，縦横の座標や方位などを用い場所を説明できる。"
               },
               "background": {
                  "ja": "・学校の見取り図などで，「(横, 縦)」のような表し方に慣れさせる。"
               }
            }
         ]
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec1300_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "目的に応じたデータの収集と分類整理"
               },
               "required_competency": {
                  "ja": "・学習課題に沿って何を集めるかを決め，表やメモに整理できる。"
               },
               "background": {
                  "ja": "・課題解決型学習を意識し，自主的にデータを集める力を育成する。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec1300_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "適切なグラフの選択"
               ...
               "required_competency": {
                  "ja": "・棒グラフ，折れ線グラフ，円グラフ等の特徴を知り，表現したい内容に合わせて選べる。"
               },
               "background": {
                  "ja": "・「経時変化なら折れ線」「割合なら円」など，グラフ選択の基準を身に付ける。"
               }
            },
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec1300_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "二次元の表"
               ...
               "required_competency": {
                  "ja": "・2つの観点を掛け合わせた表を作成し，多面的に比較や集計を行える。"
               },
               "background": {
                  "ja": "・ある程度大きめのデータでも整理できるように行列形式の見方を鍛える。"
               }
            },
            {
               "order": 400,
               "unit_id": "unit_s1_g4_sec1300_400",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "折れ線グラフ"
               ...
               "required_competency": {
                  "ja": "・横軸を時間や連続量にして，折れ線で変化を可視化できる。"
               },
               "background": {
                  "ja": "・気温変化や1日の行動記録など経時的データに適用し，その良さを体感。"
               }
            },
            {
               "order": 500,
               "unit_id": "unit_s1_g4_sec1300_500",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "結論についての考察"
               ...
               "required_competency": {
                  "ja": "・作成したグラフや表から読み取れる特徴をもとに，自分なりの結論や意見をまとめられる。"
               },
               "background": {
                  "ja": "・データの傾向を踏まえた提案（「ここを改善すれば…」など）へ展開させる。"
               }
            },
            {
               "order": 600,
               "unit_id": "unit_s1_g4_sec1300_600",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "二次元の表，折れ線グラフ"
               ...
               "required_competency": {
                  "ja": "・複数観点を掛け合わせた表や，折れ線グラフを読み取り，変化の特徴を説明できる。"
               },
               "background": {
                  "ja": "・単純な「多い/少ない」だけでなく，増減パターンや分布の偏りにも言及させる。"
               }
            }
         ]
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec1500_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "そろばんによる計算"
               ...
               "required_competency": {
                  "ja": "・4桁以上の加減や簡単なかけ算・わり算をそろばんで処理できる。"
               },
               "background": {
                  "ja": "・デジタル機器だけでなく，アナログ計算の力も伸ばしていく。"
               }
            }
         ]
      },
      {
         ...
         "units": [
            {
               "order": 100,
               "unit_id": "unit_s1_g4_sec1600_100",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "変数の概念の練習"
               ...
               "required_competency": {
                  "ja": "・数値や文字を変数として扱い，値を更新する流れを理解する。"
               },
               "background": {
                  "ja": "・具体的な入出力操作で，関数の仕組みを体感する。"
               }
            },
            {
               "order": 200,
               "unit_id": "unit_s1_g4_sec1600_200",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "関数の概念の理解の練習"
            ...
            {
               "order": 300,
               "unit_id": "unit_s1_g4_sec1600_300",
               "status": "PUBLISHED",
               "version": "1.0.0",
               "requirement": {
                  "ja": "条件分岐の概念の練習。四捨五入の手続きを利用するなど."
               },
               "required_competency": {
                  "ja": "・if文などの条件判断を通して，状況に応じた処理分岐を学ぶ。"
               },
               "background": {
                  "ja": "・if文などの条件判断を通して，状況に応じた処理分岐を学ぶ。"
               }
