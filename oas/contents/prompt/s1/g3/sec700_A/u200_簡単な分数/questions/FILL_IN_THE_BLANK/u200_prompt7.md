...
分数　の意味の理解　について、例題のように、L 単位で、分数で表すといくつになるのか回答させる問題を作成してください。
...
例題：・1/10 L は、□ こ分のかさは 1L です。

以下の間違いのように回答の空欄を分子分母に分けることはせず、必ず解答欄は１つだけにしてください
間違い：1m を 8等分した 3こ分の長さを分数で表すと、\(\frac{　}{　}\) m です。
正しい：1m を 10等分した 7こ分の長さは 何m ですか？
