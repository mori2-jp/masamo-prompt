...
```json
{
  "json_id": "qset_s1_g3_sec100_u100_v100_600",
  "order": 600,
  ...
  "memo": "5万を100倍した数はいくつですか？",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "questions": [
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_1000",
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_1100"
  ]
}
...
{
  "order": 1000,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_1000",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  ...
  "learning_requirements": [
    {
      ...
      "learning_required_competency": "大きな数を用いて万や億の表し方・単位を理解し、比べ方を認識できる",
      "learning_background": "位取りを意識しながら大きな数の計算や表し方に慣れるための基礎力を養う",
      "learning_category": "A",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "15万は150000、これを100倍すると0が2つ増えるので 15000000 となります。",
        "en": "150,000 multiplied by 100 adds two zeros to make 15,000,000."
      },
      "question": {
        "ja": "150000を100倍した数はいくつですか？",
        "en": "If you multiply 150,000 by 100, how much do you get?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "150000 に 100 をかけると、位が2つ上がって 15000000 になります。",
            "en": "When you multiply 150,000 by 100, the digits shift two places to become 15,000,000."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "大きな数を10倍、100倍などにするとき、数の位がどのように変わるかを理解することが大切です。位取りのしくみを理解しておくと、桁が増えたり減ったりする計算を正しく行うことができます。",
      "en": "When multiplying large numbers by 10, 100, and so on, it's important to understand how place value shifts. By knowing how place value works, you can accurately handle situations where digits increase or decrease in number."
    },
    "background": {
      "ja": "この問題では「万」や「億」のような大きな数の扱い方を学びます。桁が増えるしくみを理解し、数字を正しく変換する練習が目的です。",
      "en": "This problem helps learners understand how to handle large numbers like 'ten-thousand' or 'hundred-million.' The goal is to practice how digits shift when multiplying by 10, 100, or more."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
...
{
  "order": 1000,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_1100",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  ...
  "learning_requirements": [
    {
      ...
      "learning_no": 33,
      "learning_requirement": "大きな数の概念と活用 万の単位、1億などの比べ方や表し方",
      "learning_required_competency": "1万、10万、100万など大きな数の位取りや倍数の考え方を活用できる",
      "learning_background": "万の単位や1億などの比べ方や数え方への理解を深める",
      "learning_category": "A",
      "learning_grade_level": "小3"
    }
  ],
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "5万は5×10,000で50,000です。これを100倍すると50,000×100で5,000,000になり、これは「500万」と表せます。",
        "en": "Fifty thousand (5 × 10,000) equals 50,000. Multiplying 50,000 by 100 gives 5,000,000, which is written as five million."
      },
      "question": {
        "ja": "5万を100倍した数はいくつですか？",
        "en": "How many is 50,000 multiplied by 100?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "5万（50,000）を100倍すると50,000×100＝5,000,000（500万）になるためです。",
            "en": "Because 50,000 multiplied by 100 is 5,000,000 (five million)."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "万の単位を理解して、数を10倍や100倍にするときの位の変わり方を身につけましょう。5万を100倍すると、0が2つ増えるイメージで考えるとわかりやすいです。",
      "en": "Learn how each digit changes place value when multiplying large numbers by 10 or 100. Multiplying 50,000 by 100 is easier if you think of adding two more zeros to 50,000."
    },
    "background": {
      "ja": "この問題は、小学3年生が万の単位や大きな数の位取りを理解し、10倍・100倍の感覚を身につけることを目的としています。",
      "en": "This problem is designed to help third-grade students understand the 'ten-thousand' place and practice the concept of multiplying large numbers by 10 or 100."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
      ...
      "question_components": [
        {
          "type": "text",
          "content": {
            "ja": "5万 を 100倍した数はいくつですか？",
            "en": "If you multiply 50,000 by 100, how much do you get?"
          },
          "order": 50,
          "attribute": "text"
        },
