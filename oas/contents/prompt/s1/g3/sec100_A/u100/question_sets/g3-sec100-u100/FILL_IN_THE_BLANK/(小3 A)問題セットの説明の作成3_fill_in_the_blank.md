...
```json
{
  "json_id": "qset_s1_g3_sec100_u100_v100_300",
  "order": 300,
  ...
  "memo": "100万を25こあつめた数はいくつですか？",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "questions": [
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_400",
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_500"
  ]
}
...
{
  "order": 400,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_400",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  ...
  "learning_requirements": [
    {
      "learning_subject": "算数",
      "learning_no": 33,
      "learning_requirement": "数の概念 大きな数の概念と活用",
      "learning_required_competency": "万の単位、1億などの比べ方や表し方を理解し、実際に扱える",
      "learning_background": "大きな数の概念を確実にし、社会生活に生かせるようにする",
      "learning_category": "A",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "100万を25こあつめるということは、100万 × 25 の計算になります。100万は 1,000,000 なので、25 × 1,000,000 = 25,000,000（2,500万）です。",
        "en": "Gathering 25 of one million means you calculate 1,000,000 × 25. Since 1,000,000 is one million, 25 × 1,000,000 = 25,000,000."
      },
      "question": {
        "ja": "100万を25こあつめた数はいくつですか？",
        "en": "If you gather 25 of 1 million, how many is that?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "100万(1,000,000)を25回あつめるので、25 × 1,000,000 = 25,000,000（2,500万）になります。",
            "en": "Because 1,000,000 multiplied by 25 is 25,000,000."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "大きな数をまとめて考える練習を通して、万や百万の単位などに慣れることが目的です。数のしくみやくらいを意識すると、数字がどれくらい大きいかを比べたり、整理したりしやすくなります。",
      "en": "This exercise helps you practice dealing with large numbers and become familiar with units like millions. By focusing on place values, you can more easily compare and organize very large numbers."
    },
    "question": {
      "ja": "100万を25こあつめた数はいくつですか？",
      "en": "If you gather 25 of 1 million, how many is that?"
    ...
    "background": {
      "ja": "この問題は、大きな数（100万やそれ以上）をまとめて考えることで、大きい位の数字の扱いに慣れるためのものです。万の単位、百万、千万などの概念を用いて、生活や社会でよく見かける大きな数に親しむことをねらいとしています。",
      "en": "This problem aims to familiarize learners with large numbers (such as millions) by having them think in terms of higher place values. By understanding units like ten-thousands, hundred-thousands, and millions, they can apply these concepts to real-life contexts."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
...
{
  "order": 500,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_500",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "10万は100,000です。それを17個集めるので、100,000 × 17 = 1,700,000（170万）になります。",
        "en": "Ten thousand is 100,000. Gathering 17 of them means 100,000 × 17 = 1,700,000."
      },
      "question": {
        "ja": "10万を17こあつめた数はいくつですか？",
        "en": "If you gather 17 of 100 thousand, how many is that?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "10万(100,000)を17回あつめる計算をすると、100,000 × 17 = 1,700,000（170万）になるためです。",
            "en": "Because multiplying 100,000 by 17 equals 1,700,000."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "万や10万のような大きな数をいくつか集めると、とても大きな値になります。まとまりを単位として考えることで、大きな数の仕組みや位取りの考え方に慣れましょう。。",
      "en": "When you gather multiple units such as ten-thousands or hundred-thousands, the total becomes a very large number. By thinking in terms of groups (place value), you can familiarize yourself with how big numbers work."
    },
    "question": {
      "ja": "10万を17こあつめた数はいくつですか？",
      "en": "If you gather 17 of 100 thousand, how many is that?"
    ...
    "background": {
      "ja": "この問題は、万の単位を扱いながら大きな数の概念を理解する力を養うことをねらいとしています。実際に社会や生活の中でよく使われる10万（100,000）のまとまりを考え、複数個集めた合計を計算する練習です。",
      "en": "This problem is designed to help learners grasp the concept of large numbers using ten-thousand units (100,000). By practicing how to gather multiples of 100 thousand, students learn to handle large quantities often seen in daily life."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
