...
例題：1億を7こと、千万を8こと、百万を５こと、十万を６こと、一万を７こ合わせた数はいくつ？
...
```json
{
  "json_id": "qset_s1_g3_sec100_u100_v100_500",
  "order": 500,
  ...
  "memo": "10万を17こあつめた数はいくつですか？",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "questions": [
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_800",
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_900"
  ]
}
...
{
  "order": 800,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_800",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  ...
  "learning_requirements": [
    {
      ...
      "learning_background": "日常生活で見られる大きな数（金額や人口など）を正しく捉えられるようにし、計算への応用力を育成する",
      "learning_category": "A",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "score": "number",
      "question_text": {
        "ja": "下の問題の答えを、数字で書きなさい。",
        "en": "Write the answer in numerical form."
      },
      "explanation": {
        "ja": "1億は100000000（1×10^8）なので、2つ分で200000000。千万（1×10^7）は3つで30000000。百万（1×10^6）は4つで4000000。十万（1×10^5）は5つで500000。これらを足し合わせると234500000になります。",
        "en": "One hundred million is 100,000,000, so two sets make 200,000,000. Ten million is 10,000,000, and three sets make 30,000,000. One million is 1,000,000, and four sets make 4,000,000. One hundred thousand is 100,000, and five sets make 500,000. Summing all of these results in 234,500,000."
      },
      "question": {
        "ja": "1億を2つ、千万を3つ、百万を4つ、十万を5つ合わせた数はいくつですか？",
        "en": "If you combine 2 sets of one hundred million, 3 sets of ten million, 4 sets of one million, and 5 sets of one hundred thousand, how many is that in total?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "2×100000000（2億）＋3×10000000（3千万）＋4×1000000（4百万）＋5×100000（5十万）の合計です。",
            "en": "Add 2×100,000,000 (two hundred million) + 3×10,000,000 (thirty million) + 4×1,000,000 (four million) + 5×100,000 (five hundred thousand) to get the total."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "question_text": {
      "ja": "つぎの▢に、答えを数字で書きましょう。",
      "en": "Please fill in the blank with the numerical answer."
    },
    "explanation": {
      "ja": "大きな数を扱うときの位のしくみに気づき、どのようにまとめて考えられるかを学ぶ問題です。単位ごとのまとまりを意識しながら数をしっかり読み取る練習になります。",
      "en": "This problem helps you notice how place value works with large numbers and how to think of them in grouped units. It offers practice in reading and understanding numbers carefully, paying attention to each place value."
    },
    "question": {
      "ja": "1億を2つ、千万を3つ、百万を4つ、十万を5つ合わせた数はいくつですか？",
      "en": "If you combine 2 sets of one hundred million, 3 sets of ten million, 4 sets of one million, and 5 sets of one hundred thousand, how many is that in total?"
    ...
    "background": {
      "ja": "この問題では、万や億などの大きな位を正しく使い、数を組み立てる力を養います。実生活で見かける大きな数を正しく理解するためにも、位に注目する練習が大切です。",
      "en": "This exercise aims to strengthen your ability to use larger place values such as ten thousand or hundred million correctly. Focusing on place values is important for understanding large numbers in real-life contexts."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
