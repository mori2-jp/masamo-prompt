...
generate_question_prompt　には、具体的な問題例を必ず含んでください。
...
```json
{
  "json_id": "qset_s1_g3_sec100_u100_v100_700",
  "order": 700,
  ...
  "memo": "1000万は100万の何倍ですか？",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "questions": [
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_1200",
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_1300"
  ]
}
...
{
  "order": 1200,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_1200",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  ...
  "learning_requirements": [
    {
      "learning_subject": "算数",
      "learning_no": 33,
      "learning_requirement": "大きな数の概念と活用 万・億の単位などの比べ方や表し方",
      "learning_required_competency": "万の位から億の位までの大きな数の概念を理解し、比べ方や表し方を説明できる",
      "learning_background": "十進位取り記数法を拡張し、大きな数をどのように比較・表現するかを学ぶ",
      "learning_category": "A",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "score": "number",
      "question_text": {
        "ja": "次の空欄にあてはまる数を答えましょう。",
        "en": "Please fill in the correct number in the blank below."
      },
      "explanation": {
        "ja": "1億（100,000,000）と100万（1,000,000）との関係を考える問題です。1億をいくつ集めたか、または100万を何回繰り返した数かを考えると答えが出ます。",
        "en": "This problem is about understanding the relationship between 100 million (1億) and 1 million (100万). Think about how many times 1 million is needed to reach 100 million."
      },
      "question": {
        "ja": "1億は100万の何倍ですか？",
        "en": "How many times bigger is 100 million (100,000,000) than 1 million (1,000,000)?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "1,000,000 × 100 = 100,000,000 になるため、答えは 100 です。",
            "en": "Because 1,000,000 multiplied by 100 equals 100,000,000, the answer is 100."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "1億が100万の100倍であることを理解することで、大きな数の比べ方を習得します。",
      "en": "By understanding that 100 million is 100 times 1 million, you will learn how to compare large numbers."
    },
    "background": {
      "ja": "この問題は、万や億といった大きな単位を比べる力を養うためのものです。日常生活や社会で使われる大きな数を正しく比較し、理解できるようになることがねらいです。",
      "en": "This problem aims to develop the skill of comparing large units such as ten-thousand and hundred-million, which are often used in daily life and society."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
      ...
      "question_components": [
        {
          ...
          "content": {
            "ja": "1億は100万の何倍ですか？ ",
            "en": "How many times bigger is 100 million than 1 million? "
          },
          "order": 50,
          "attribute": "text"
        },
...
{
  "order": 1300,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_1300",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  ...
  "learning_requirements": [
    {
      ...
      "learning_required_competency": "万・十万・百万・千万・億の位について理解し、それらの大小関係や倍の関係を把握できる",
      "learning_background": "大きな数の理解を促し、日常生活での数の活用につなげるため",
      "learning_category": "A",
      "learning_grade_level": "小3"
    }
  ],
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "1000万(10 million)が100万(1 million)の何倍かを考える問題です。大きな数を比べるときは、単位の大きさをそろえて割り算をすることで「何倍か」を求められます。",
        "en": "This question asks how many times bigger ten million is compared to one million. When comparing large numbers, aligning their units and dividing helps us find “how many times” larger one number is than another."
      },
      "question": {
        "ja": "1000万は100万の何倍ですか？",
        "en": "How many times bigger is 10 million than 1 million?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "1000万を100万で割ると10になるためです。",
            "en": "Dividing ten million by one million gives 10."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "1000万と100万の大小関係をもとに、何倍になるかを計算します。1000万÷100万＝10 となるので、答えは10倍です。",
      "en": "We compare ten million to one million by dividing: 10,000,000 ÷ 1,000,000 = 10, so the answer is 10 times."
    },
    "background": {
      "ja": "この問題は、大きな数を比較して「何倍か」を求める力をつけるためのものです。万や百万、千万といった単位を正しく理解し、日常生活や学習で役立つ感覚を身に付けることをねらいとしています。",
      "en": "This problem is designed to help learners understand how to compare large numbers and determine how many times bigger one is than another. Mastering units like ten thousand, hundred thousand, one million, and ten million is useful in daily life and further studies."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
