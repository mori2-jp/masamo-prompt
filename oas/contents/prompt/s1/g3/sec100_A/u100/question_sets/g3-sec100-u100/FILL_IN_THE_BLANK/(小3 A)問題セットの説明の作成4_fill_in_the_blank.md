...
```json
{
  "json_id": "qset_s1_g3_sec100_u100_v100_400",
  "order": 400,
  ...
  "memo": "900万は、10万をいくつあつめた数ですか？",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "questions": [
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_600",
    "ques_s1_g3_sec100_u100_diff100_qt51_v100_700"
  ]
}
...
{
  "order": 600,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_600",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  ...
  "learning_requirements": [
    {
      "learning_subject": "算数",
      "learning_no": 15,
      "learning_requirement": "数の概念 大きな数",
      "learning_required_competency": "最大5桁の整数を正しく読み書き・比較できる",
      "learning_background": "位取りの概念をさらに拡張し，万の位を扱うことに慣れる",
      "learning_category": "A",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "900万（9,000,000）は、10万（100,000）が何こ分かをたずねています。大きい数のわり算で、いくつあるかを考えてみましょう。",
        "en": "We are asking how many 100,000s fit into 9,000,000. Think about dividing a large number to find how many times it contains another number."
      },
      "question": {
        "ja": "900万は、10万をいくつあつめた数ですか？",
        "en": "9,000,000 is how many times 100,000?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "900万 ÷ 10万＝90 となるので、答えは 90 です。",
            "en": "Since 9,000,000 ÷ 100,000 = 90, the answer is 90."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "question_text": {
      "ja": "つぎの▢にあてはまる数を答えましょう。",
      "en": "Please answer the number that fits in the blank."
    },
    "explanation": {
      "ja": "大きな数をまとまりで考える力を養う問題です。位のしくみや、かけ算・わり算の考え方を活用して、数を整理しながら考えてみましょう。",
      "en": "This exercise focuses on grouping large numbers. Use place value understanding and the ideas of multiplication or division to organize and handle big numbers."
    },
    "question": {
      "ja": "900万は、10万をいくつあつめた数ですか？",
      "en": "9,000,000 is how many times 100,000?"
    ...
    "background": {
      "ja": "この問題は、大きな数のくらいとわり算の考え方を確認するためのものです。万や十万といった単位で、どのくらい集まるかを考える力を養います。",
      "en": "This problem is designed to check your understanding of place values in large numbers and division. It helps reinforce the concept of how many times a specific large unit can fit into another."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
...
{
  "order": 700,
  "id": "ques_s1_g3_sec100_u100_diff100_qt51_v100_700",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  ...
  "learning_requirements": [
    {
      "learning_subject": "算数",
      "learning_no": 33,
      "learning_requirement": "大きな数の概念と活用",
      "learning_required_competency": "万の単位や億の単位を正しく読み、書き、比べられる",
      "learning_background": "計算だけでなく、日常生活での大きい数への理解を深めるために、数のまとまりを考える力を強化する",
      "learning_category": "A",
      "learning_grade_level": "小3"
    }
  ],
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "3000万（30,000,000）を1万（10,000）で割ると、いくつあるかを考えます。大きな数でも、位に注目してわり算することで簡単に答えがわかります。",
        "en": "We consider how many ten thousands (10,000) fit into thirty million (30,000,000). Even for large numbers, focusing on place values and division makes the answer straightforward."
      },
      "question": {
        "ja": "3000万は、1万をいくつあつめた数ですか？",
        "en": "30,000,000 is how many times 10,000?"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "30,000,000 ÷ 10,000 = 3,000 となるため、答えは3,000です。",
            "en": "Since 30,000,000 ÷ 10,000 = 3,000, the correct answer is 3,000."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "explanation": {
      "ja": "大きな数を単位ごとに考える力を養うための問題です。位のしくみに注目し、どれだけまとまりができるかを意識して数をとらえてみましょう。",
      "en": "This exercise is designed to build skills in handling large numbers by grouping them into units. Pay attention to place value to see how many groups fit into the given number."
    },
    "question": {
      "ja": "3000万は、1万をいくつあつめた数ですか？",
      "en": "30,000,000 is how many times 10,000?"
    ...
    "background": {
      "ja": "この問題は、小学校３年生が大きな数を扱うときの感覚を身に付けるため、1万や10万単位でいくつあるか考えられるようにすることがねらいです。",
      "en": "This problem helps third graders develop a feel for large numbers, focusing on how many times 10,000 fits into a given large number."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
