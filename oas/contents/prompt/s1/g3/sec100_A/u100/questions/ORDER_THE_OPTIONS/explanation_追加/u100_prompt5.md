...
ORDER_THE_OPTIONSの例題を参考に、以下のような大きな数の大きさの正しく理解するための、数字と文字数字（日本語では　漢数字、英語では　alphanumeric expression）をミックスした並び替え問題を作問して 。question は1問で。
5　次の数を左から大きい順に並べなさい
9億　　90000000　　1億
...
{
  "order": 1000,
  "id": "ques_s1_g3_sec100_u100_diff100_qt301_v100_1000",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "generated_by_llm": false,
  "created_at": "2025-04-09 13:00:00",
  "updated_at": "2025-04-09 13:00:00",
  ...
  "learning_requirements": [
    {
      "learning_subject": "算数",
      "learning_no": 33,
      "learning_requirement": "A 数と計算 > 数の概念 > 大きな数の概念と活用 > sec_s1_g3_100",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "8億（800,000,000）、5億（500,000,000）、1億（100,000,000）の順に大きくなります。8億が最も大きく、その次に5億、最後に1億です。",
        "en": "Eight hundred million (800,000,000) is the largest, followed by five hundred million (500,000,000), and then one hundred million (100,000,000)."
      },
      "question": {
        "ja": "8億, 500000000, 1億",
        "en": "eight hundred million, five hundred million, one hundred million"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "8億（約8×10^8）が最も大きく、次に5億（約5×10^8）、最後に1億（約1×10^8）です。",
            "en": "800 million is the largest, then 500 million, and finally 100 million."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "background": {
      "ja": "この問題では、1億や数億など大きな数を正しく読み書きする力を育てることをねらいとしています。日本語表記と英語表記を対応させ、大きさの比較が正しくできるように学習します。",
      "en": "This problem aims to help learners correctly read, write, and compare large numbers such as hundreds of millions, fostering a deeper understanding of their scale. By pairing Japanese and English notations, students become more confident in handling these big numbers."
    },
    "question": {
      "ja": "8億, 500000000, 1億",
      "en": "eight hundred million, five hundred million, one hundred million"
      ...
      "question_components": [
        {
          "type": "text",
          "content": {
            "ja": "次の3つの数を左から大きい順に並べましょう。",
            "en": "Arrange these three numbers in descending order (largest on the left)."
          },
          "order": 50
        },
        {
