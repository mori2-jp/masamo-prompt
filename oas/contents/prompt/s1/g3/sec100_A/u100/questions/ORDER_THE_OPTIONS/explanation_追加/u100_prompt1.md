...
{
  "order": 600,
  "id": "ques_s1_g3_sec100_u100_diff100_qt301_v100_600",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "generated_by_llm": false,
  "created_at": "2025-04-09 14:00:00",
  "updated_at": "2025-04-09 14:00:00",
  "skills": [
    {
      "skill_id": "sk_004",
      "name": "知識・技能"
  ...
  "learning_requirements": [
    {
      ...
      "learning_required_competency": "万の単位、1億などの比べ方や表し方",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "question_text": {
        ...
        "en": "Arrange the following three numbers from largest to smallest."
      },
      "explanation": {
        "ja": "3つの数を比べるときは、位の大きい方が数が大きくなります。102500000（約1億250万） > 25710000（約2571万） > 89301（約8万9301）となるので、その順番に並べます。",
        "en": "When comparing these three numbers, focus on the higher place values to see which is larger. 102500000 (about 102.5 million) > 25710000 (about 25.71 million) > 89301 (about 89 thousand)."
      },
      "question": {
        "ja": "102500000, 25710000, 89301",
        "en": "102500000, 25710000, 89301"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "field_explanation": {
            "ja": "102500000 (約1億250万) > 25710000 (約2571万) > 89301 (約8万9301) の順に並べます。",
            "en": "They should be ordered as 102500000 (about 102.5 million), followed by 25710000 (about 25.71 million), then 89301 (about 89 thousand)."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "background": {
      "ja": "この問題は、1億や1000万といった大きな数を正しく比較できるようになることを目的としています。数の位をしっかり読み取ることで、より大きな数と小さい数を区別する練習をします。",
      "en": "This problem helps learners practice comparing large numbers such as hundreds of millions or tens of millions by understanding place values more accurately."
    },
    "input_format": {
      "type": "fixed",
      "input_components": [
      ...
      "question_components": [
        {
          "type": "text",
          "content": {
            "ja": "5 次の数を左から大きい順に並べなさい（1問）",
            "en": "5. Please arrange the following three numbers from largest to smallest (1 item)."
          },
          "order": 50
        },
        {
