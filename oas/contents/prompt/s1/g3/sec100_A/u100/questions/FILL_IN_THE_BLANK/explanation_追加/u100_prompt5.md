...
```json
{
  ...
  "metadata": {
    ...
    "background": {
      "ja": "この問題では、万や億の単位を使って大きな数を扱う力を育て、日常生活で見られる金額や人口などの数値を正しく理解する力を養うことを目的としています。",
      "en": "The purpose of this problem is to help students practice using large units like 'million' and 'hundred million' so that they can accurately handle large numbers seen in everyday contexts like money amounts or population figures."
    },
    "input_format": {
      "type": "fixed",
      "fields": [
