...
{
  "order": 700,
  "id": "ques_s1_g3_sec100_u100_diff100_qt301_v100_700",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "question_text": {
        ...
        "en": "Arrange the following numbers in descending order (largest first)."
      },
      "explanation": {
        "ja": "三十四百万は34,000,000、八百九十七万は8,970,000、五百八十万は5,800,000となるので、この順番になります。",
        "en": "Thirty-four million is 34,000,000, eight million nine hundred seventy thousand is 8,970,000, and five million eight hundred thousand is 5,800,000. Therefore, the sequence is in that order."
      },
      "question": {
      ...
      "fields": [
        {
          ...
          "field_explanation": {
            "ja": "三十四百万=34,000,000 > 八百九十七万=8,970,000 > 五百八十万=5,800,000 の順です。",
            "en": "Because 34,000,000 > 8,970,000 > 5,800,000 in descending order."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "background": {
      "ja": "この問題は、大きな数の読み書きと比較に慣れるためのものです。数を日本語表記と英語表記両方で確認することで、位取りや数のスケールをより明確に把握する力を育てます。",
      "en": "This question helps learners practice reading, writing, and comparing large numbers in both Japanese and English notation. It enhances their understanding of place values and the scale of large numbers."
    },
    "input_format": {
      "input_components": [
        {
