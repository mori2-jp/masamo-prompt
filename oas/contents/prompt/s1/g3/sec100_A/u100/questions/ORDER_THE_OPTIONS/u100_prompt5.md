...
ORDER_THE_OPTIONSの例題を参考に、以下のような大きな数の大きさの正しく理解するための、１億の単位の混ざった数字だけ（漢数字、alphanumeric expression　ではない）の並び替え問題を作問して 。question は1問で。
5　次の数を左から大きい順に並べなさい
(1)　201207000　　20150700　　200777
