...
{
  "order": 900,
  "id": "ques_s1_g3_sec100_u100_diff100_qt301_v100_900",
  "level_id": "lev_003",
  "grade_id": "gra_003",
  "difficulty_id": "diff_100",
  "version": "1.0.0",
  "status": "PUBLISHED",
  "generated_by_llm": false,
  "created_at": "2025-04-09 11:00:00",
  "updated_at": "2025-04-09 11:00:00",
  "skills": [
    {
      "skill_id": "sk_004",
      "name": "知識・技能"
  ...
  "evaluation_spec": {
    ...
    "response_format": {
      ...
      "explanation": {
        "ja": "9億は900,000,000、1億は100,000,000、90,000,000はそのまま90,000,000です。数を大きい順に比べると、9億＞1億＞90,000,000の並びになります。",
        "en": "Nine hundred million is 900,000,000, one hundred million is 100,000,000, and 90,000,000 is 90,000,000. In descending order, 900,000,000 > 100,000,000 > 90,000,000."
      },
      "question": {
        "ja": "9億, 90000000, 1億",
        "en": "nine hundred million, ninety million, one hundred million"
      },
      "fields": [
        {
          "field_id": "f_1",
          ...
          "collect_answer": {
            "ja": "[9億, 1億, 90000000]",
            "en": "[nine hundred million, one hundred million, ninety million]"
          },
          "field_explanation": {
            "ja": "9億(900,000,000)が最大、次に1億(100,000,000)、最後に90,000,000の順となるためです。",
            "en": "900,000,000 is the largest, followed by 100,000,000, and then 90,000,000."
          }
        }
      ]
    }
  ...
  "metadata": {
    ...
    "background": {
      "ja": "この問題は、大きな数（億単位）の読み方と位取りを正しく理解し、数の大小関係をつかむために作成されています。日本語と英語両方の表記で比べる練習をすることで、大きい数の感覚を養います。",
      "en": "This problem is designed to help learners correctly read and understand large numbers (on the order of hundreds of millions) and compare their sizes. By comparing both Japanese and English notations, they can develop a stronger sense of scale for large numbers."
    },
    "input_format": {
      "type": "custom",
      "fields": [
