...
# 条件
・No36（56	小3	A 数と計算	式・関係	式の表現	sec_s1_g3_1100	□を用いた式）についての問題を作成してください
7-□+5=12のように，2段階の計算で減数ががわからない”形の「逆算問題」を使って、減数が2桁の□を未知数として扱い答えを導けることを目的に、
例題のような計算を回答させる問題を作成してください。 question は1問だけね。
