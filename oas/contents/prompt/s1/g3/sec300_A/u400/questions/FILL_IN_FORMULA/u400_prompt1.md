...
https://chatgpt.com/share/67e0f745-1924-8010-8e5c-453edab7a741"


わり算の意味 について、例題のような整数と少数第一位（整数込） - 整数と少数第一位（整数込）で整数から少数への繰り下がりがある問題を作成してください。 question は1問だけね。
例題：少数+少数 8.2 - 5.7 = 2.7
